...
namespace PluginMaster.DesignTools.Editor.PrefabWorldBuilder.Scripts
{
    ...
    public static class TilesUtils
    {
        ...
        public static Vector3 GetCellSize(SizeType cellSizeType, BrushSettings brush,
            ...
            Vector3 DefaultValue, bool tangentSpace = true)
        {
            ...
            {
                cellSize = Quaternion.Euler(AxesUtils.SignedAxis.GetEulerAnglesFromAxes(forwardAxis, upwardAxis)) * cellSize;
    ...
    public class ModularToolBase : IToolSettings, IPaintToolSettings
    {
        ...
        public TilesUtils.SizeType moduleSizeType
        {
            get => _moduleSizeType;
            set
            {
        ...
        public virtual Vector3 GetCellSize(BrushSettings brush)
        {
            ...
            return TilesUtils.GetCellSize(moduleSizeType, brush, upwardAxis, forwardAxis, moduleSize, tangentSpace: false);
        }
        public virtual void UpdateCellSize()
        {
            if (moduleSizeType != TilesUtils.SizeType.CUSTOM)
            {
