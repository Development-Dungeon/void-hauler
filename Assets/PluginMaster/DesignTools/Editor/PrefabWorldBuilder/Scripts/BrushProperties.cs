...
using PluginMaster.DesignTools.Editor.CommonPaint.Scripts;
using UnityEngine;
                ...
                else
                {
                    using (new GUILayout.HorizontalScope())
                    {
                        using (var check = new UnityEditor.EditorGUI.ChangeCheckScope())
                        {
                            ...
                            if (check.changed || brush.patternMachine != _previewPatternMachine
                                || brush.patternMachine == null)
                            {
                                _patternWarningMsg = null;
                                switch (PatternMachine.Validate(brush.pattern, brush.items.Length,
                                ...
                                _previewPatternMachine = brush.patternMachine;
                            }
