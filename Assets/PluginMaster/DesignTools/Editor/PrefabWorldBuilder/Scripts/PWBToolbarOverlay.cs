...
namespace PluginMaster.DesignTools.Editor.PrefabWorldBuilder.Scripts
{
    ...
    {
        private static System.Collections.Generic.Dictionary<ToolManager.PaintTool, IPWBToogle> _toggles = null;
        private static System.Collections.Generic.Dictionary<ToolManager.PaintTool, IPWBToogle> toggles
        {
            get
            {
                if (_toggles == null)
                {
                    _toggles = new System.Collections.Generic.Dictionary<ToolManager.PaintTool, IPWBToogle>()
                    {
    ...
    public class WallsToggle : ToolToggleBase<WallsToggle>
    {
        ...
        public WallsToggle() : base()
        {
            ...
            tooltip = ToggleManager.GetTooltip("Walls", PWBSettings.shortcuts.toolbarPinToggle.combination.ToString());
        }
    }
    [UnityEditor.Toolbars.EditorToolbarElement(ID, typeof(UnityEditor.SceneView))]
    public class FloorsToggle : ToolToggleBase<FloorsToggle>
    {
        ...
        public FloorsToggle() : base()
        {
            ...
            tooltip = ToggleManager.GetTooltip("Floors", PWBSettings.shortcuts.toolbarPinToggle.combination.ToString());
        }
    }
    [Icon("Assets/PluginMaster/DesignTools/PrefabWorldBuilder/Editor/Resources/Sprites/Walls.png")]
    ...
    public class ModularEnvironmentsToolbarOverlay : UnityEditor.Overlays.ToolbarOverlay
    {
        ...
        ModularEnvironmentsToolbarOverlay() : base(FloorsToggle.ID, WallsToggle.ID) => displayedChanged += OndisplayedChanged;
    ...
    public class PWBPropPlacementToolbarOverlay : UnityEditor.Overlays.ToolbarOverlay
    {
        ...
        PWBPropPlacementToolbarOverlay() : base(PinToggle.ID, BrushToggle.ID, GravityToggle.ID, LineToggle.ID,
            ShapeToggle.ID, TilingToggle.ID, ReplacerToggle.ID, EraserToggle.ID, PropertiesButton.ID, HelpButton.ID)
        {
